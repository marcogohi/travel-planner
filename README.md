...
- [x] Ajuste en vivo (11 ago): el tren Lijiang→Shangri-La de las 17:52 es directo, sin parada en Tiger Leaping Gorge — se corrigió el bloque, que describía erróneamente una parada allí
- [x] Mejorada la usabilidad en escritorio (la app está pensada para móvil, pero se pulieron varios detalles): `.wrap` gana algo más de ancho a partir de 900px de viewport, la barra de pestañas de días muestra scrollbar visible y admite scroll con la rueda del ratón en dispositivos con puntero fino, y los mapas de cada día permiten zoom con la rueda solo en desktop (en móvil se mantiene desactivado para no atrapar el scroll de la página)
